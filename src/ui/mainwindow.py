...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.predImgView = QtWidgets.QGraphicsView(self.groupBox_8)
        self.predImgView.setGeometry(QtCore.QRect(20, 300, 181, 181))
        self.predImgView.setObjectName("predImgView")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.cmbQ13.setItemText(0, _translate("MainWindow", "1"))
        self.cmbQ13.setItemText(1, _translate("MainWindow", "2"))
        self.cmbQ13.setItemText(2, _translate("MainWindow", "3"))
        self.cmbQ13.setItemText(3, _translate("MainWindow", "4"))
        self.cmbQ13.setItemText(4, _translate("MainWindow", "5"))
        self.cmbQ13.setItemText(5, _translate("MainWindow", "6"))
        self.cmbQ13.setItemText(6, _translate("MainWindow", "7"))
        self.cmbQ13.setItemText(7, _translate("MainWindow", "8"))
        self.cmbQ13.setItemText(8, _translate("MainWindow", "9"))
        self.cmbQ13.setItemText(9, _translate("MainWindow", "10"))
        self.cmbQ13.setItemText(10, _translate("MainWindow", "11"))
        self.cmbQ13.setItemText(11, _translate("MainWindow", "12"))
        self.cmbQ13.setItemText(12, _translate("MainWindow", "13"))
        self.cmbQ13.setItemText(13, _translate("MainWindow", "14"))
        self.cmbQ13.setItemText(14, _translate("MainWindow", "15"))
